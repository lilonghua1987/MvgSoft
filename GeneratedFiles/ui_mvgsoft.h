...
public:
    ...
    void setupUi(QMainWindow *MvgSoftClass)
    {
        ...
        QIcon icon14;
        icon14.addFile(QStringLiteral(":/MvgSoft/openFile"), QSize(), QIcon::Normal, QIcon::Off);
        menuOpen->setIcon(icon14);
        menuTools = new QMenu(menuBar);
        menuTools->setObjectName(QStringLiteral("menuTools"));
        QIcon icon15;
        icon15.addFile(QStringLiteral(":/MvgSoft/Tools"), QSize(), QIcon::Normal, QIcon::Off);
        menuTools->setIcon(icon15);
        menuMatche = new QMenu(menuTools);
        menuMatche->setObjectName(QStringLiteral("menuMatche"));
        QIcon icon16;
        icon16.addFile(QStringLiteral(":/MvgSoft/match"), QSize(), QIcon::Normal, QIcon::Off);
        menuMatche->setIcon(icon16);
        menuPipeLine = new QMenu(menuTools);
        menuPipeLine->setObjectName(QStringLiteral("menuPipeLine"));
        QIcon icon17;
        icon17.addFile(QStringLiteral(":/MvgSoft/piple"), QSize(), QIcon::Normal, QIcon::Off);
        menuPipeLine->setIcon(icon17);
        menuReconstruct = new QMenu(menuBar);
        menuReconstruct->setObjectName(QStringLiteral("menuReconstruct"));
        QIcon icon18;
        icon18.addFile(QStringLiteral(":/MvgSoft/reconstruct"), QSize(), QIcon::Normal, QIcon::Off);
        menuReconstruct->setIcon(icon18);
